...
export default function Services() {
    ...
    useEffect(() => {
        ...
        tl.from('#video', { xPercent: -300, yPercent: 20, duration: 2, ease: 'Power4.easeOut' })
    }, [])
